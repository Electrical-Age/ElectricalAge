...
public class ItemDefault extends Default {
    ...
    public void initGui() {
        ...
        for (IRecipe recipe : CraftingManager.REGISTRY) {
            ...
            if (out.getItem() == stack.getItem() && out.getItemDamage() == stack.getItemDamage()) {
                recipeOutList.add(recipe);
            }

            for (ItemStack rStack : Utils.getRecipeInputs(recipe)) {
                if (rStack != null && rStack.getItem() == stack.getItem() && rStack.getItemDamage() == stack.getItemDamage()) {
                    recipeInList.add(recipe);
                    break;
                }
            }
        }
        ...
        if (recipeInList.isEmpty()) {
            ...
            for (IRecipe r : recipeInList) {
                ...
                if (stacks != null) {
                    ...
                    GuiItemStack gui = new GuiItemStack((int) (3.5 * 18) + 6 + counter * 105, 18 + y, r.getRecipeOutput(), helper);
                    extender.add(gui);
