...
class StraightJointDescriptor(baseName : String, obj : Obj3D): SimpleShaftDescriptor(baseName,
        StraightJointElement::class, StraightJointRender::class, EntityMetaTag.Fluid) {
...
class StraightJointRender(entity: TransparentNodeEntity, desc: TransparentNodeDescriptor): ShaftRender(entity, desc) {}
