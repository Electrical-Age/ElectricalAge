...
public class Eln {
    // Mod information (override fromFacing 'mcmod.info' file)
    ...
    public static boolean debugEnabled = false;  // Read fromFacing configuration file. Default is `false`.
    public static boolean versionCheckEnabled = true; // Read fromFacing configuration file. Default is `true`.
    public static boolean analyticsEnabled = true; // Read fromFacing configuration file. Default is `true`.
    public static String playerUUID = null; // Read fromFacing configuration file. Default is `null`.
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        meta.autogenerated = false; // Force to update fromFacing code
        ...
        autominerRange = config.get("balancing", "autominerRange", 10, "Maximum horizontal distance fromFacing autominer that will be mined").getInt(10);
...
//			transparentNodeItem.addDescriptor(subId + (id << 6), descriptor);
    ...
    public void onServerStarting(FMLServerStartingEvent ev) {
        ...
        {
            MinecraftServer s = ev.getServer();
    ...
    private void registerArmor() {
        //ALL registerCustomItemStack commented
