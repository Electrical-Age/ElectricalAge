...
public class PowerCapacitorSixGui extends GuiContainerEln {
    ...
    protected void postDraw(float f, int x, int y) {
        helper.drawString(8, 8, 0xFF000000, tr("Capacity: %1$F", Utils.plotValue(render.getDescriptor().getCValue(render.getInventory()))));
        helper.drawString(8, 8 + 8 + 1, 0xFF000000, tr("Nominal voltage: %1$V", Utils.plotValue(render.getDescriptor().getUNominalValue(render.getInventory()))));
