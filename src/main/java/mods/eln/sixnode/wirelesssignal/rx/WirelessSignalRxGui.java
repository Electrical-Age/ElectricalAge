...
public class WirelessSignalRxGui extends GuiScreenEln {
    ...
    public void initGui() {
        ...
        int x = 6;
        int y = 6 + 12 + 4;
        add(buttonBigger = new AggregatorBt(x, y, w, 20, "Biggest", (byte) 0));
        x += 2 + w;
        add(buttonSmaller = new AggregatorBt(x, y, w, 20, "Smallest", (byte) 1));
        x += 2 + w;
        add(buttonToogle = new AggregatorBt(x, y, w, 20, "Toggle", (byte) 2));
        x += 2 + w;
