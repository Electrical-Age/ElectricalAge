...
public class ElectricalMathDescriptor extends SixNodeDescriptor implements IPlugIn {
    ...
    public int top(int y, GuiVerticalExtender extender, ItemStack stack) {
        extender.add(new GuiLabel(6, y, "Executable math operators:"));
        y += 9;
        extender.add(new GuiLabel(6, y, "  + - * / > < "));
        y += 9;
        y += 9;
        extender.add(new GuiLabel(6, y, "Executable boolean operators:"));
        y += 9;
        extender.add(new GuiLabel(6, y, "  & | = ^"));
        y += 9;
        y += 9;
        extender.add(new GuiLabel(6, y, "Executable functions:"));
        y += 9;
