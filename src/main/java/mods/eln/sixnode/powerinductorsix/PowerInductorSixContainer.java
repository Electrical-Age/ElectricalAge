...
public class PowerInductorSixContainer extends BasicContainer {
    ...
    public PowerInductorSixContainer(EntityPlayer player, IInventory inventory) {
        super(player, inventory, new Slot[]{
                new GenericItemUsingDamageSlot(inventory, cableId, 132, 8, 19, CopperCableDescriptor.class, SlotSkin.medium, new String[]{"Copper Cable slot", "(Increases inductance value)"}),
