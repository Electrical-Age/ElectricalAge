...
public class I18N {
	...
	private static class SourceCodeParser {
		...
		public static void parseSourceFolderRecursive(final File folder, final Map<String, Set<String>> strings)
            throws IOException {
    ...
    public static void main(String... args) {
        try {
            ...
            Map<String,Set<String>> stringsToTranslate = new TreeMap<String, Set<String>>();
            SourceCodeParser.parseSourceFolderRecursive(srcFolder, stringsToTranslate);
