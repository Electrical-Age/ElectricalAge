    ...
    public void renderBlockFace(int x, int y, float spritDim) {
        switch (this) {
            case XN:
                ...
                GL11.glTexCoord2f((x + 1) * spritDim, (y + 0) * spritDim);
                GL11.glVertex3f(-0.5F, 0.5F, 0.5f);
                GL11.glTexCoord2f((x + 0) * spritDim, (y + 0) * spritDim);
                GL11.glVertex3f(-0.5F, 0.5F, -0.5f);
                GL11.glTexCoord2f((x + 0) * spritDim, (y + 1) * spritDim);
                GL11.glVertex3f(-0.5F, -0.5F, -0.5f);
                GL11.glTexCoord2f((x + 1) * spritDim, (y + 1) * spritDim);
                GL11.glVertex3f(-0.5F, -0.5F, 0.5f);
                break;
            case XP:
                GL11.glNormal3f(1.0f, 0.0f, 0.0f);
