...
public class ElectricalDataLoggerContainer extends BasicContainer {
	...
	public ElectricalDataLoggerContainer(EntityPlayer player, IInventory inventory) {
		super(player, inventory,new Slot[]{
				new SlotFilter(inventory,paperSlotId,62 + 0,17,64,new ItemStackFilter[]{new ItemStackFilter(Item.paper)}),
				new GenericItemUsingDamageSlot(inventory, printSlotId, 62 + 18, 17, 1, DataLogsPrintDescriptor.class)
			});
