...
public class IntelligentTransformerContainer extends BasicContainer {
	...
	public IntelligentTransformerContainer(EntityPlayer player, IInventory inventory) {
		super(player, inventory,new Slot[]{
				new SixNodeItemSlot(inventory,0,62 +  0,17,1,new Class[]{ElectricalCableDescriptor.class}),
				new SixNodeItemSlot(inventory,1,62 + 18,17,1,new Class[]{ElectricalCableDescriptor.class}),
				new GenericItemUsingDamageSlot(inventory,2,62 + 0,17 + 18,1,new Class[]{FerromagneticCoreDescriptor.class})
