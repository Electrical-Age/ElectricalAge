...
public abstract class NodeBlockEntity extends TileEntity {
    ...
    void onBlockPlacedBy(Direction front,EntityLiving entityLiving,int metadata)
    {
    	if(!worldObj.isRemote)
    	{
    ...
    public Node getNode()
    {
    	if(node == null) node = NodeManager.instance.getNodeFromCoordonate(new Coordonate(xCoord, yCoord, zCoord,this.worldObj));
    	return node;
    }
