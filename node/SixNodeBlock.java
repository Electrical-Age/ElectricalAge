...
/*
    ...
    @Override
    public boolean onBlockPlacedBy(World world, int x, int y, int z, Direction direction,EntityLiving entityLiving,int metadata)
    {
	...
	*/
    ...
    public MovingObjectPosition collisionRayTrace(World world, int x, int y, int z,EntityLiving entityLiving)
    {
