...
public class EggIncubatorContainer extends BasicContainer implements INodeContainer {
	...
	public EggIncubatorContainer(EntityPlayer player, IInventory inventory, Node node) {
		super(player, inventory, new Slot[]{
				new SlotFilter(inventory, EggSlotId, 176 / 2 - 8, 7, 64, new ItemStackFilter[]{new ItemStackFilter(Items.egg)}, SlotSkin.medium, new String[]{Translator.translate("eln.core.egg.slot.hint")})
