...
*/
    ...
    void registerElectricalCable(int id)
    {
    	...
    	ElectricalCableDescriptor desc;
    	{
	    	...
	    	stdCableRenderSignal = new CableRenderDescriptor("eln","/sprites/CABLE.PNG",1,0.95f);
    	...
    	
    	{
	    	...
	    	stdCableRender50V = new CableRenderDescriptor("eln","/sprites/CABLE.PNG",2,1.5f);
    	...
    	
    	{
	    	...
	    	stdCableRender200V = new CableRenderDescriptor("eln","/sprites/CABLE.PNG",3,1.95f);
    	...
    	//	highVoltageCableId = subId;
	    	...
	    	stdCableRender800V = new CableRenderDescriptor("eln","/sprites/CABLE.PNG",3.9f,2.9f);
